...
_G.packer_plugins = {
  ...
  ["lir.nvim"] = {
    ...
    loaded = true,
    path = "/Users/havoc/.local/share/lunarvim/site/pack/packer/start/lir.nvim",
  ...
  ["nvim-navic"] = {
    ...
    loaded = true,
    path = "/Users/havoc/.local/share/lunarvim/site/pack/packer/start/nvim-navic",
  ...
  ["tokyodark.nvim"] = {
    loaded = true,
    path = "/Users/havoc/.local/share/lunarvim/site/pack/packer/start/tokyodark.nvim",
  ...
  ["vim-illuminate"] = {
    ...
    loaded = true,
    path = "/Users/havoc/.local/share/lunarvim/site/pack/packer/start/vim-illuminate",
