...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/havoc/.local/share/lunarvim/site/pack/packer/start/cmp-cmdline",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'twilight.nvim', 'zen-mode.nvim', 'Comment.nvim', 'gitsigns.nvim', 'hop.nvim', 'lsp_signature.nvim', 'nvim-bqf', 'editorconfig-vim', 'nvim-spectre'}, { event = "BufRead *" }, _G.packer_plugins)]]
